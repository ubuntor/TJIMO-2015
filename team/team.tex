...
\begin{problem}
% (2.5) (2016skim) 
In triangle ABC, AB = 12 feet and BC = 10 feet. If the altitude of ABC from side AB is equal to 5 feet, what is the altitude of ABC from side BC in inches?
\end{problem}
...
\begin{solution}
The area of a triangle is $\frac{1}{2}bh$, where $b$ is a base of a triangle and $h$ is the base's corresponding height. Looking at the base of 5, the area is $\frac{1}{2} \times 12 \times 5 = 30$. Looking at the other pair, the area is $\frac{1}{2} \times 10h$. Thus, $\frac{1}{2} \times 10 h = 30$, so $h = 6$ feet, or \boxed{72} inches.
\end{solution}
