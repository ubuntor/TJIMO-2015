...
\newtheorem*{solutionone}{Solution 1}
\newtheorem*{solutiontwo}{Solution 2}
...
\newcommand{\righthead}{\fdbox{Round}{Individual}\fdbox{Name}{\phantom{Samuel Hsiang}}\fdbox{Math Level}{\phantom{Samuel Hsiang}}}
