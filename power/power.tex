...
you do not need section 2 to complete section 3. It might be wise to split up your team, with one half working on section 2 and the other team working
on section 3.
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[2 points] % 1
What is the minimum number of edges needed for a graph with $n$ vertices to be connected? Remember to explain your answer!
\end{problem}\end{minipage}}

\fbox{\begin{minipage}{0.98	\textwidth}\begin{solution}
We need $\boxed{n-1}$ edges. Consider the number of parts that are connected to each other. We can decrease this number by 1 each time we add an edge by adding an edge between two previously unconnected parts. As our graph begins with $n$ parts that are not connected, and we want to end up with 1 unconnected part, we need $n-1$ edges to merge these $n$ parts into 1.
\end{solution}\end{minipage}}

From now on, all graphs we consider will be connected.

\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[2 points] % 2
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[2 points] % 3
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[3 points] % 4
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[2 points] % 5
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[4 points] % 6
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[2 points] % 7
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[3 points] % 8
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[2 points, Seven Bridges of K\"{o}nigsberg] % 9
...
also part of the city. As pictured, seven bridges connect the four land masses: Two from $A$ to $B$, two from $A$ to $C$, one from $A$ to $D$, one from $B$ to $D$, and one from $C$ to $D$.ß Is it possible to walk through the city but cross every bridge exactly once?
...
\fbox{\begin{minipage}{0.98	\textwidth}\begin{problem}[4 points] % 10
